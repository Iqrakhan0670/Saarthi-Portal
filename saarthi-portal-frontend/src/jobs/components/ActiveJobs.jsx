...
const ActiveJobs = () => {
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/api/jobs/${editFormData.id}`,
        {
          method: "PUT",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/api/jobs/${showDeleteConfirm}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
              ...
              {editFormData.postingAs === "consultancy" && (
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("consultancyHiringFor", e.target.value)
                    }
