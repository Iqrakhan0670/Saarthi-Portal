...
const Applicants = () => {
  ...
  const saveApplicantStatus = async () => {
    ...
    try {
      ...
      const attempts = [
        {
          url: `${API_BASE_URL}/api/applications/${selectedApplicant.id}/status`,
          method: "PATCH",
          type: "json",
        },
        {
        ...
        {
          url: `${API_BASE_URL}/api/applications/${selectedApplicant.id}`,
          method: "PATCH",
          type: "json",
        },
        {
      ...
      for (const attempt of attempts) {
        try {
          ...
          if (attempt.type === "json") {
            ...
            fd.append(
              "applicant_name",
              (selectedApplicant.applicant_name || "").trim(),
            );
            fd.append(
              "applicant_email",
              (selectedApplicant.applicant_email || "").trim(),
            );
            fd.append(
              "applicant_mobile",
              (selectedApplicant.applicant_mobile || "").trim(),
            );
      ...
      if (!succeeded) {
        ...
        setStatusError(
          serverMsg || "Failed to update status. Please try again.",
        );
        return;
      }
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-lg text-gray-600 mt-2">
                  View all applicants who have applied to your job postings
                </p>
              </div>
            </div>
            <button
          ...
          {jobsWithApplicants.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-600">
                Applicants will appear here once people apply to your jobs.
              </p>
            </div>
          ) : (
                                  ...
                                  {applicant.cv_url && (
                                    <button
                                      onClick={(e) => {
                                        ...
                                        handleDownloadCV(
                                          applicant.cv_url,
                                          `${(applicant.applicant_name || "applicant").replace(/\s+/g, "_")}_resume.pdf`,
                                        );
                                      }}
                                      title="Download CV"
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center space-x-3 p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-100">
                    ...
                    <span className="text-gray-700 font-medium">
                      {selectedApplicant.applicant_mobile}
                    </span>
                  </div>
                </div>
                <div className="space-y-6">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <button
                      onClick={() =>
                        handleDownloadCV(
                          selectedApplicant.cv_url,
                          `${selectedApplicant.applicant_name.replace(/\s+/g, "_")}_resume.pdf`,
                        )
                      }
                  ...
                  <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div className="relative">
                      {(() => {
                        ...
                        if (
                          selectedApplicant.cv_url &&
                          selectedApplicant.cv_url.includes(
                          ...
                          selectedApplicant.cv_url &&
                          selectedApplicant.cv_url.startsWith("/")
                        ) {
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full mx-auto">
            <div className="p-6 text-center">
              ...
              <p className="text-gray-600 mb-6">
                The application status has been changed to{" "}
                {statusLabel(statusUpdateValue)}.
              </p>
              <button
