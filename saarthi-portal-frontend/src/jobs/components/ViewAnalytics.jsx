...
const ViewAnalytics = () => {
  ...
  const [view, setView] = useState("oneClick");
  const [oneClickPeriod, setOneClickPeriod] = useState("yesterday");
  const [customFromDate, setCustomFromDate] = useState("");
  const [customToDate, setCustomToDate] = useState("");
  const [customApplyCount, setCustomApplyCount] = useState("custom");
  ...
  const [reportDisplay, setReportDisplay] = useState(null);
    ...
    const fetchSubscription = async () => {
      try {
        const response = await fetch(
          `${API_BASE_URL}/api/analytics/subscription`,
          {
            method: "GET",
            headers: {
  ...
  const handleGenerateOneClickReport = async () => {
    ...
    try {
      const response = await fetch(
        `${API_BASE_URL}/api/analytics/one-click?period=${oneClickPeriod}`,
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-gray-500">
                Get instant insights for your selected period.
              </p>
              <button
        ...
        {view === "autoEmail" && (
          <div className="bg-white rounded-lg shadow-sm p-6">
            <h2 className="text-xl font-semibold mb-4">
              Auto Emailing of Job Posting Reports
            </h2>
            <div className="space-y-6">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                ...
                <div className="space-y-2">
                  ...
                  <label className="flex items-center space-x-2">
                    ...
                    />
                    <span>
                      Monthly (Previous Month Report delivered 1st of every
                      month)
                    </span>
                  </label>
                </div>
