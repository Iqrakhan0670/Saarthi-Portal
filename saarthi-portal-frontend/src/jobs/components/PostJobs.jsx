...
const allSkills = Array.from(
  new Set(Object.values(skillDatabase).flat()),
).sort();
...
const PostJobs = () => {
  ...
  const suggestedSkills = useMemo(() => {
    ...
    // If user is typing, search from all available skills
    if (inputLower) {
      return allSkills
    ...
    // If no input, show job title-specific skills
    ...
    return skillsForTitle.filter((skill) => !formData.skills.includes(skill));
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert(
          "Failed to post job: " +
            (data.errors?.join(", ") || data.error || "Unknown error"),
        );
      }
    } catch (error) {
        ...
        <div className="w-full px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-600 text-center">
              Find the perfect candidate for your team with our comprehensive
                      ...
                      <div className="flex space-x-4">
                        <label className="flex items-center space-x-2">
                          <input
                            ...
                            onChange={(e) =>
                              handleInputChange("postingAs", e.target.value)
                            }
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="relative">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              handleInputChange("payMin", e.target.value)
                            }
                            className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white"
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              handleInputChange("payMax", e.target.value)
                            }
                            className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white"
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-8 shadow-sm">
                  <div className="space-y-6">
                    ...
                    <div className="border-b border-gray-200 pb-6">
                      <h1 className="text-3xl font-bold text-gray-700 mb-2 text-left">
                        {formData.jobTitle}
                      </h1>
