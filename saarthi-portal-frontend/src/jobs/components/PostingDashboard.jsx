                ...
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Your dashboard helps you keep up with your hiring
                      priorities. Manage open jobs, update job statuses and
                      filter applications easily.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 border-b border-gray-200">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Review and manage applicants effortlessly. Filter,
                      shortlist, and connect with top talent in one place.
                    </p>
                  </div>
                </div>
              </div>
