...
const HireNumber = () => {
  ...
  useEffect(() => {
    const fetchHiredCandidates = async () => {
      try {
        ...
        allHired.sort(
          (a, b) => new Date(b.hiredTimestamp) - new Date(a.hiredTimestamp),
        );
  ...
  useEffect(() => {
    const interval = setInterval(updateFormattedDates, 60000);
          ...
          <div className="flex justify-between items-center mb-8">
            <div>
              ...
              <p className="text-lg text-gray-600">
                Congratulations on your successful hires! View details of
                candidates who joined your team.
              </p>
            </div>
            <button
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-700">
                    Recently Hired Talent
                  </h3>
                  <p className="text-gray-600 text-sm">
                    These candidates have been successfully onboarded to your
                    team.
                  </p>
                </div>
              </div>
              ...
              {hiredCandidates.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600">
                    Your team is growing! Hired candidates will appear here.
                  </p>
                </div>
              ) : (
