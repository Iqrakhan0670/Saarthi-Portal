...
const FindCandidate = () => {
  ...
  const performSearch = async (
    ...
    try {
      ...
      if (!token) {
        setSearchError("You must be logged in to search for candidates.");
        setLoading(false);
        return;
      }
  ...
  `${API_BASE_URL}/api/candidates/search?${params}`,
      ...
      if (!response.ok) {
        ...
        throw new Error(
          `Failed to search candidates: ${response.status} - ${errorData.error || "Unknown error"}`,
        );
      }
          ...
          <div className="space-y-6">
                ...
                <table className="w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-gray-300 px-4 py-2">
                        CVs will contain both of the items when using the AND
                        operator
                      </td>
                    </tr>
                    <tr className="bg-gray-50">
                      ...
                      <td className="border border-gray-300 px-4 py-2">
                        CVs will contain at least one of the items in the OR
                        list
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-gray-300 px-4 py-2">
                        CVs will not contain the phrase when using the NOT
                        operator
                      </td>
                    </tr>
                    <tr className="bg-gray-50">
                      ...
                      <td className="border border-gray-300 px-4 py-2">
                        To search for an exact phrase, insert quotation marks
                        around the phrase
                      </td>
                    </tr>
                    <tr>
            ...
            <div>
              ...
              <p className="text-gray-600 mb-3 text-left">
                I am looking for "Software Engineer" candidates. Their resume
                must have the keyword "python" mentioned in any section. Exclude
                any candidates that have "Java" or "CSS" mentioned in any
                section of their CV.
              </p>
              <div className="bg-gray-100 p-3 rounded font-mono text-sm">
                "Software Engineer"{" "}
                <span className="text-red-600 font-bold">AND</span> "python"{" "}
            ...
            <div>
              ...
              <p className="text-gray-600 mb-4 text-left">
                Boolean fields allow you to target specific sections in the CV.
                You can combine them with boolean operators (AND, OR, NOT,
                etc.). You can input your desired value to match against any
                field; you can also use one or more fields in your query.
              </p>
                ...
                <table className="w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-gray-300 px-4 py-2">
                        Any company in past experience
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-gray-300 px-4 py-2">
      ...
      <div className="bg-white rounded-2xl max-w-md w-full shadow-2xl transform transition-all">
        <div className="p-6 text-center">
          ...
          <p className="text-gray-600 mb-6">
            We couldn't find any candidates matching your search. Try adjusting
            your keywords or location for better results.
          </p>
          ...
          <div className="flex justify-center items-center">
            <div className="max-w-4xl w-full">
              <div className="text-center mb-8">
                <p className="text-gray-600 mb-6">
                  To conduct a search, complete at least one field in the Job,
                  Find CVs, Work experience, or Education section and select
                  Find candidates.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl shadow-xl border border-blue-200 p-8 mb-8">
                ...
                <div className="text-center py-6">
                  ...
                  <p className="text-gray-700 text-lg">
                    Use{" "}
                    <span className="font-bold text-blue-800">Keywords</span> to
                    search millions of global CVs and find qualified candidates.
                  </p>
                </div>
              </div>
            </div>
              ...
              {candidates.map((candidate) => (
                ...
                >
                  <div className="flex items-start justify-between mb-4">
                    ...
                    >
                      <Bookmark
                        className={`w-5 h-5 ${savedCandidates.has(candidate.id) ? "fill-current" : ""}`}
                      />
                    </button>
                  </div>
