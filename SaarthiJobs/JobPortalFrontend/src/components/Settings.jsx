...
const Settings = () => {
      ...
      try {
        ...
        if (res.ok) {
          ...
          if (data.communication_preferences) {
            try {
              prefs =
                typeof data.communication_preferences === "string"
                  ? JSON.parse(data.communication_preferences)
  ...
  const handleSaveCommunicationSettings = async () => {
    ...
    try {
      const res = await fetch(`${API_BASE_URL}/api/settings/communication`, {
        ...
        body: JSON.stringify({
          communication_preferences: { emailNotifications },
        }),
      });
      if (!res.ok) {
        const d = await res.json();
        throw new Error(
          d.error || "Failed to update communication preferences",
        );
      }
      setOriginalData((prev) => ({
        ...prev,
  ...
  const handleCancel = () => {
    ...
    setEmailNotifications(
      (originalData.communication_preferences || {}).emailNotifications !==
        false,
    );
    setActiveSection(null);
    setError(null);
    ...
    <div className="bg-white min-h-screen pb-12">
        ...
        <div className="fixed top-0 left-0 right-0 z-50 bg-yellow-100 border-b border-yellow-400 shadow-lg">
          <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
            <span className="text-yellow-800 font-semibold">
              Not signed in — please sign in to load and edit your settings.
            </span>
            <button
              onClick={() => setNotSignedIn(false)}
      ...
      <section className="bg-gradient-to-br from-blue-50 to-white py-12">
        <div className="max-w-4xl mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-700 mb-2 text-center">
            Account <span className="text-blue-800">Settings</span>
          </h1>
        ...
        <div className="max-w-4xl mx-auto px-4 space-y-8">
          ...
          {tokenAvailable &&
            ...
            !(
              ...
              <div className="p-4 rounded border bg-yellow-50 text-yellow-800">
                No profile information found for your account. You can edit and
                save your account details below.
              </div>
            )}
          {/* Account */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className={`mt-1 block w-full rounded border px-3 py-2 ${activeSection !== "account" ? "opacity-80" : ""}`}
                />
              </div>
              <div>
                <label className="text-sm font-medium text-gray-700">
              ...
              {activeSection === "account" ? (
                <>
                  <button
                    ...
                    disabled={isLoading || !hasAccountChanged}
                    className="bg-blue-800 disabled:bg-gray-400 text-white px-4 py-2 rounded"
                  >
          ...
          <div className="bg-white rounded-lg p-6 shadow border">
              ...
              <div>
                ...
                <div className="mt-1 relative">
                  <input
                    ...
                    className={`block w-full rounded border px-3 py-2 ${activeSection !== "password" ? "opacity-80" : ""}`}
                  />
                  <button
            ...
            {activeSection !== "password" && (
              <p className="mt-3 text-sm text-gray-600 bg-gray-50 p-2 rounded">
                For security, your password is not displayed. Click Edit and
            ...
            <div className="flex items-center justify-between">
              ...
              <div>
                <button
                  ...
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${emailNotifications ? "bg-blue-800" : "bg-gray-300"}`}
                >
                  <span
          ...
          <div className="bg-red-50 rounded-lg p-6 shadow border border-red-200">
            ...
            <p className="text-sm text-gray-700 mb-4">
              ...
              all associated data will be deleted from our system.
            </p>
            ...
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
              <div className="bg-white rounded-lg p-8 max-w-md w-full shadow-xl">
                ...
                <p className="text-gray-700 mb-4">
                  This action is permanent and irreversible. Your account and
