...
const PosterMessage = () => {
  ...
  const handleSendOrUpdateMessage = async () => {
    ...
    try {
      ...
      const url = isEdit
        ? `${API_BASE_URL}/api/messages/${selectedMessage.id}`
      ...
      if (!response.ok) {
        throw new Error(
          isEdit ? "Failed to update message" : "Failed to send message",
        );
      }
      ...
      <div className="bg-white min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Loading {view === "sent" ? "messages" : "applicants"}...
          </p>
        </div>
      </div>
    );
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            {jobsWithApplicants.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600">
                  Post a job to start receiving applications and messages.
                </p>
              </div>
            ) : (
              <div className="space-y-6">
                {jobsWithApplicants.map((job) => {
                  ...
                  if (filteredCount === 0 && selectedStatus !== "all")
                    return null; // Hide jobs with no matching applicants
                  return (
                    <div
                      key={job.id}
                        ...
                        <div className="p-6">
                          {filteredCount === 0 ? (
                            <p className="text-gray-500 text-center py-8">
                              No applicants matching the selected status.
                            </p>
                          ) : (
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center space-x-3 mb-2">
                          ...
                          <div>
                            <h5 className="font-medium text-gray-700">
                              {msg.sender_name || "Unknown Recipient"}
                            </h5>
