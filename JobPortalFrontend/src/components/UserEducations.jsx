...
const Education = () => {
  ...
  const fetchEducation = async () => {
    try {
      const response = await apiRequest("/api/usereducations", {
        method: "GET",
      });
  ...
  const saveAllEducation = async () => {
    ...
    forms.forEach((form, index) => {
      if (!form.degree || !form.institution || !form.courseType) {
        errors.push(
          `Form ${index + 1}: Please fill in all required fields (Degree, Institution, and Course Type).`,
        );
      }
    });
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap gap-4 text-sm text-gray-500">
                    ...
                    {edu.course_required_pass && (
                      <span>Course Required Pass</span>
                    )}
                  </div>
                </div>
              ...
              >
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-2xl font-bold text-gray-900">
                    {editingIndex !== null && formIndex === forms.length - 1
                      ? "Edit Education"
                      : "Add Education"}
                  </h2>
                  <button
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      value={form.degree}
                      onChange={(e) =>
                        handleInputChange(formIndex, "degree", e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={form.endYear}
                      onChange={(e) =>
                        handleInputChange(formIndex, "endYear", e.target.value)
                      }
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={form.cgpa}
                      onChange={(e) =>
                        handleInputChange(formIndex, "cgpa", e.target.value)
                      }
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
