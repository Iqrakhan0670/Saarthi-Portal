...
const SavedCandidates = () => {
  ...
  const fetchSavedCandidates = async () => {
    try {
      ...
      setSuccessMessage(
        `Loaded ${transformedCandidates.length} saved candidate${transformedCandidates.length !== 1 ? "s" : ""}.`,
      );
        ...
        <div className="p-6 text-center">
          ...
          <p className="text-gray-600 mb-6">
            ...
            <span className="font-semibold">
              {candidateToUnsave?.first_name} {candidateToUnsave?.last_name}
            </span>{" "}
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-600 mt-2">
                    Manage your bookmarked candidates and find the perfect
                    match.
                  </p>
                </div>
              </div>
      ...
      {savedCandidates.length > 0 ? (
          ...
          <div className="max-w-6xl mx-auto">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold text-gray-800">
                {savedCandidates.length} Saved Candidate
                {savedCandidates.length !== 1 ? "s" : ""}
              </h2>
            </div>
        ...
        <section className="py-12 px-4">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-gray-600 mb-6">
              You haven't saved any candidates yet. Start searching and bookmark
              the ones you like.
            </p>
            <button
